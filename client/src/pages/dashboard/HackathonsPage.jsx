        ...
        <div className="flex gap-6 items-start min-w-0 flex-1">
          ...
          <div className="min-w-0 flex-1 space-y-2">
            <div className="flex flex-wrap items-center gap-3">
               <h3 className="text-xl sm:text-2xl font-headline font-black text-white leading-tight group-hover:text-amber-500 transition-colors break-words break-all italic uppercase tracking-tighter">
                {hackathon.title}
              </h3>
