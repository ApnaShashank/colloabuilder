      ...
      >
        <div className={`max-w-[1600px] mx-auto transition-all duration-500 relative ${
          ...
          <div className="flex items-center justify-between px-6 sm:px-10 py-4 relative">
            ...
            <Link href="/" className="flex items-center gap-4 group flex-1">
            ...
            <div className="flex items-center justify-end gap-3 flex-1">
              {user ? (
                ...
                <div className="flex items-center gap-4">
                  <Link href="/login" className="hidden sm:block text-[10px] font-black uppercase tracking-[0.2em] text-neutral-500 hover:text-white transition-colors">
                    Login
                  </Link>
                  <Link href="/signup">
                    <motion.button
